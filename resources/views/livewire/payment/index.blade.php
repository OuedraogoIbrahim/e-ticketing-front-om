            ...
            <div class="row">
                            ...
                            <div class="form-check custom-option custom-option-basic checked">
                                <label
                                    ...
                                    <span class="custom-option-body">
                                        <img src="{{ asset('assets/img/orange-money-logo.jpg') }}" alt="orange-money"
                                            width="58">
                        ...
                        <div class="row g-6">
                            <div class="col-md-6">
                                ...
                                <input type="number" id="nombre_tickets"
                                    ...
                                    wire:model.live.debounce.500ms="nombre_tickets" min="1" required />
                            ...
                            <div class="col-md-6">
                                ...
                                <input wire:model="telephone" type="tel" id="phone"
                ...
                <div class="col-lg-5 card-body p-md-8">
                    ...
                    <div class="bg-lighter p-6 rounded">
                        ...
                        <p>Prix unitaire: <strong>{{ number_format($event->prix, 0, ',', ' ') }} FCFA</strong></p>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="d-grid mt-5">
                            <button class="btn btn-success" wire:click="purchase">
